...
@section('contenedor')
    ...
    <div class="container mt-3 mb-3 text-center w-50" style="background-color: rgb(219, 203, 164); ">
        ...
        <h2>El caballero de los siete reinos</h2>
        <hr>
        <img src="/img/libro4.jpg" class="img-fluid text-center" style="width: 300px; height:400px"><br>
        <label><strong>Autor:</strong>George R.R Martin</label><br>
        <label><strong>Saga:</strong>Canción de hielo y fuego II</label><br>
        <label><strong>Editorial:</strong>Altaya</label><br>
        ...
        <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#comprarLibro"
            data-whatever="El caballero de los siete reinos">Comprar</button>
