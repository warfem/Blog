...
@section('contenedor')
    ...
    <div class="container mt-3 mb-3 text-center w-50" style="background-color: rgb(219, 203, 164); ">
        ...
        <h2>El camino de los reyes</h2>
        <hr>
        <img src="/img/libro3.jpg" class="img-fluid text-center" style="width: 300px; height:400px"><br>
        ...
        <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#comprarLibro"
            data-whatever="El camino de los reyes">Comprar</button>
